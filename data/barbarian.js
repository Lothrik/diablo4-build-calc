...
Tags: Basic, Bludgeoning, Fury, Physical, Damage, Crowd Control, Two-Handed.`,
	...
	"Enhanced Bash": {
		...
		description: `Damaging a Stunned enemy with Bash grants you 20% Base Life as Fortify. Double this amount when using a Two-Handed weapon.`,
		nameLocalized: {
		...
		descriptionLocalized: {
			"deDE": "Wenn Ihr einem betäubten Gegner mit Hieb Schaden zufügt, erhaltet Ihr 20% Eures Basislebens als Stählung. Diese Menge verdoppelt sich, wenn Ihr Zweihandwaffen verwendet.",
			"esES": "Infligir daño a un enemigo aturdido con Porrazo te otorga un 20% de tu vida base como fortificación. Esta cantidad se duplica al usar un arma de dos manos.",
			"esMX": "Infligir daño a un enemigo aturdido con Porrazo te fortifica con un 20% de tu vida de base. La cantidad se duplica cuando usas un arma de dos manos.",
			"frFR": "Infliger des dégâts à une cible étourdie avec Raclée vous confère un montant de fortification égal à 20% de vos points de vie de base. Ce montant est doublé lorsque vous utilisez une arme à deux mains.",
			"itIT": "Infliggere danni a un nemico stordito con Colpo Poderoso ti fornisce il 20% della Vita base come Fortificazione. Questo ammontare raddoppia se usi un'arma a due mani.",
			"jaJP": "スタン中の敵に〈バッシュ〉でダメージを与えると、基本ライフの20%にあたるの強化を獲得する。両手用武器を使用している場合、この効果は2倍になる。",
			"koKR": "후려치기로 기절한 적에게 피해를 주면 기본 생명력의 20%에 해당하는 보강 효과를 얻습니다. 양손 무기를 사용 중일 경우 효과가 2배로 증가합니다.",
			"plPL": "Zranienie ogłuszonego wroga Grzmotnięciem zapewnia ci 20% podstawowego zdrowia jako umocnienie. Wartość ta podwaja się w przypadku korzystania z broni dwuręcznej.",
			"ptBR": "Causar dano a um inimigo atordoado com Trombar concede a você 20% de vida básica como fortificação. O valor é dobrado ao usar uma arma de duas mãos.",
			"ruRU": "Когда \"Сокрушающий удар\" наносит урон оглушенному противнику, вы получаете укрепление в объеме 20% базового запаса здоровья. Этот объем удваивается при использовании двуручного оружия.",
			"trTR": "Sersemletilmiş bir düşmana Darbe ile hasar vermek sana 20% Temel Canı Güçlendirme olarak kazandırır. Çift El silah kullanırken bu miktar ikiye katlanır.",
			"zhCN": "使用猛击对被击昏的敌人造成伤害强固你 20% 基础生命。使用双手武器时该数值翻倍。",
			"zhTW": "以猛擊對昏迷的敵人造成傷害,可賦予你等同 20% 基礎生命值的強韌。使用雙手武器會使此效果加倍。"
},
		id: 1,
		maxPoints: 1,
		x: -276.815,
...
Tags: Basic, Bleed, Slashing, Fury, Damage, Physical.`,
	...
	"Enhanced Flay": {
		...
		descriptionLocalized: {
			...
			"zhTW": "剝皮有 15% 機率使敵人易傷,持續 2 秒。使用雙手武器時該機率加倍。"
},
		id: 13,
		maxPoints: 1,
		x: 721.251,
...
Tags: Core, Damage, Physical, Fury, Two-Handed.`,
	...
	"Furious Upheaval": {
		baseSkill: "Upheaval",
		connections: [ "Enhanced Upheaval" ],
		description: `Dealing direct damage to an enemy with a Skill that is not Upheaval causes your next cast of Upheaval to deal x5% increased damage, stacking up to 10 times.`,
		nameLocalized: {
		...
		descriptionLocalized: {
			"deDE": "Wenn Ihr einem Gegner mit einer anderen Fertigkeit als Aufwühlen direkten Schaden zufügt, verursacht Euer nächster Einsatz von Aufwühlen x5% mehr Schaden (bis zu 10-mal stapelbar).",
			"esES": "Infligir daño directo a un enemigo con una habilidad que no sea Ataque tectónico hace que tu siguiente lanzamiento de Ataque tectónico inflija un x5% más de daño. Se acumula hasta 10 veces.",
			"esMX": "Infligir daño directo a un enemigo con una habilidad que no sea Conmoción provoca que tu siguiente lanzamiento de Conmoción inflija un x5% más de daño. El efecto se acumula hasta 10 veces.",
			"frFR": "Infliger des dégâts directs à une cible avec une autre compétence que Soulèvement augmente de x5% les dégâts de votre prochaine utilisation de Soulèvement, cet effet pouvant se cumuler jusqu'à 10 fois.",
			"itIT": "Infliggere danni diretti a un nemico con un'abilità che non sia Tumulto fa sì che il tuo successivo lancio di Tumulto infligga il x5% di danni aggiuntivi, fino a un massimo di 10 volte.",
			"jaJP": "〈打ち払い〉以外のスキルで敵に直接ダメージを与えると、次の〈打ち払い〉で与えるダメージがx5%増加する。この効果は10回まで蓄積する。",
			"koKR": "지각 변동이 아닌 기술로 적에게 직접 피해를 주면 다음 지각 변동 시전 시 주는 피해가 x5% 증가하며, 이 효과는 최대 10번까지 중첩됩니다.",
			"plPL": "Zadawanie wrogowi bezpośrednich obrażeń umiejętnością inną niż Wypiętrzenie sprawia, że przy kolejnym użyciu Wypiętrzenie zada obrażenia zwiększone o x5%. Efekt ten kumuluje się maksymalnie 10 razy.",
			"ptBR": "Causar dano direto a um inimigo com uma habilidade que não seja Revolta faz com que seu próximo lançamento de Revolta cause 5% de dano aumentado, acumulando até 10 vezes.",
			"ruRU": "Когда вы наносите прямой урон любым умением, кроме \"Выброса земли\", ваш следующий \"Выброс земли\" наносит на x5% больше урона. Эффект суммируется до 10 раз.",
			"trTR": "Ayaklanma olmayan bir yetenekle bir düşmana doğrudan hasar vermek, bir sonraki Ayaklanma kullanımının x5% artırılmış hasar vermesini sağlar ve 10 kez biriktirilebilir.",
			"zhCN": "使用扬石飞沙之外的技能对敌人造成直接伤害, 可以使你的下一次扬石飞沙造成的伤害提高 x5%, 该效果最多可叠加 10 次。",
			"zhTW": "使用動盪震擊以外的技能對敵人造成直接傷害,會使你下一次施放動盪震擊造成的傷害提高 x5%,最多可堆疊 10 次。"
},
		id: 23,
		maxPoints: 1,
		x: -1021.685,
...
Tags: Weapon Mastery, Damage, Physical, Cooldown.`,
	...
	"Enhanced Death Blow": {
		...
		descriptionLocalized: {
			...
			"ptBR": "Golpe Mortal causa 150% de dano aumentado contra chefes.",
...
Tags: Weapon Mastery, Bleed, Damage, Physical, Cooldown, Slashing.`,
	...
	"Fighter's Rupture": {
		...
		description: `Hitting at least 1 enemy with Rupture Heals you for 18% of your Maximum Life.`,
		nameLocalized: {
		...
		descriptionLocalized: {
			"deDE": "Wenn Ihr mindestens 1 Gegner mit Blutspieß trefft, werdet Ihr um 18% Eures maximalen Lebens geheilt.",
			"esES": "Golpear a al menos 1 enemigo con Ruptura te cura un 18% de tu vida máxima.",
			"esMX": "Golpear al menos a 1 enemigo con Ruptura te sana un 18% de tu vida máxima.",
			"frFR": "Toucher au moins 1 adversaire avec Rupture vous rend 18% de votre maximum de points de vie.",
			"itIT": "Colpendo almeno 1 nemico con Strazio ti curi del 18% della tua Vita massima.",
			"jaJP": "〈ラプチャー〉を少なくとも1体の敵に命中させると、ライフが最大値の18%にあたるを回復する。",
			"koKR": "파열을 1마리 이상의 적에게 적중시키면 자신의 최대 생명력의 18%만큼 생명력을 회복합니다.",
			"plPL": "Trafienie co najmniej 1 wroga Rozerwaniem przywraca 18% twojego maksymalnego zdrowia.",
			"ptBR": "Atingir pelo menos 1 inimigo com Ruptura cura 18% da sua vida máxima.",
			"ruRU": "Поразив хотя бы 1 противника \"Разрывом\", вы восполняете 18% максимального запаса здоровья.",
			"trTR": "Kesik ile en az 1 düşmana vurmak seni Maksimum Canının 18% kadarına eşit İyileştirir.",
			"zhCN": "割裂命中至少 1 名敌人可以为你恢复 18% 生命上限。",
			"zhTW": "以血肉橫飛擊中至少 1 個敵人,可使你恢復生命值上限的 18%。"
},
		id: 99,
		maxPoints: 1,
		x: 962.76,
	...
	"Warrior's Rupture": {
		baseSkill: "Rupture",
		connections: [ "Enhanced Rupture" ],
		description: `Hitting enemies with Rupture increases your Attack Speed by +30% for 5 seconds.`,
		nameLocalized: {
		...
		descriptionLocalized: {
			"deDE": "Wenn Ihr mit Blutspieß Gegner trefft, erhöht sich Eure Angriffsgeschwindigkeit 5 Sek. lang um +30%.",
			"esES": "Golpear a enemigos con Ruptura aumenta tu velocidad de ataque un +30% durante 5 s.",
			"esMX": "Golpear enemigos con Ruptura aumenta tu velocidad de ataque un +30% durante 5 segundos.",
			"frFR": "Toucher des adversaires avec Rupture augmente votre vitesse d'attaque de +30% pendant 5 s.",
			"itIT": "Colpire i nemici con Strazio aumenta la tua velocità d'attacco del +30% per 5 s.",
			"jaJP": "敵に〈ラプチャー〉を命中させると、攻撃速度が5秒間+30%上昇する。",
			"koKR": "파열을 적에게 적중시키면 5초 동안 공격 속도가 +30% 증가합니다.",
			"plPL": "Trafianie wrogów Rozerwaniem zwiększa twoją szybkość ataku o +30% na 5 sek.",
			"ptBR": "Atingir inimigos com Ruptura aumenta sua velocidade de ataque em +30% por 5 segundos.",
			"ruRU": "Когда вы поражаете противников \"Разрывом\", ваша скорость атаки повышается на +30% на 5 сек.",
			"trTR": "Kesik ile düşmanlara vurmak 5 saniyeliğine Saldırı Hızını +30% artırır.",
			"zhCN": "割裂命中敌人会使你的攻击速度提高 +30%, 持续 5 秒。",
			"zhTW": "以血肉橫飛擊中敵人會使你攻擊速度提高 +30%,持續 5 秒。"
},
		id: 100,
		maxPoints: 1,
		x: 674.33,
...
Tags: Bleed, Crowd Control, Healthy.`,
		...
		descriptionLocalized: {
			...
			"jaJP": "出血効果が健全状態の敵の移動速度を{20/40/60/80/100/120/140/160/180/200}%低下させる。\n\nTags: 出血, 操作障害効果, 健全.",
...
Tags: Vulnerable, Bleed, Damage.`,
		...
		descriptionLocalized: {
			...
			"jaJP": "脆弱状態の敵に与える出血効果がx{5/10/15/20/25/30/35/40/45/50}%増加する。\n\nTags: 脆弱, 出血, ダメージ.",
			...
			"ptBR": "Seus efeitos de sangramento causam {5/10/15/20/25/30/35/40/45/50}% de dano aumentado contra inimigos vulneráveis.\n\nTags: Vulnerável, Sangramento, Dano.",
...
Tags: Ultimate, Damage, Physical, Cooldown.`,
	...
	"Prime Call of the Ancients": {
		...
		descriptionLocalized: {
			...
			"ptBR": "Enquanto Chamado dos Ancestrais está ativo, recebe +20% de bônus de velocidade de ataque e 10% de dano aumentado.",
...
Tags: Ultimate, Crowd Control, Bleed, Damage, Physical, Cooldown, Two-Handed, Bludgeoning, Dual Wield, Slashing.`,
	...
	"Prime Iron Maelstrom": {
		...
		descriptionLocalized: {
			...
			"ptBR": "Maelstrom de Ferro recebe +30% de chance de acerto crítico aumentada e causa 40% de dano de acerto crítico aumentado.",
...
Tags: Ultimate, Unstoppable, Berserking, Cooldown, Basic.`,
	...
	"Supreme Wrath of the Berserker": {
		...
		description: `While Wrath of the Berserker is active, every 50 Fury you spend increases Berserking's damage bonus by x25%.`,
		nameLocalized: {
		...
		descriptionLocalized: {
			"deDE": "Solange Zorn des Berserkers aktiv ist, wird der Schadensbonus des Berserkermodus pro 50 verbrauchter Wut um x25% erhöht.",
			"esES": "Mientras dura Cólera de berserker, cada 50 de furia que gastes aumenta un x25% el bonus de daño del estado de vesania.",
			...
			"frFR": "Tant que Courroux du berserker est actif, le bonus aux dégâts de Rage du berserker est augmenté de x25% chaque fois que vous dépensez 50 points de fureur.",
			...
			"plPL": "Kiedy Gniew Berserkera jest aktywny, za każde wykorzystane przez ciebie 50 pkt. furii premia do obrażeń od berserkowania jest zwiększona o x25%.",
			...
			"trTR": "Başıbozuğun Gazabı etkinken harcadığın her 50 Hiddet, Başıbozukluk hasar bonusunu x25% artırır.",
...
Tags: Berserking, Damage.`,
		...
		descriptionLocalized: {
			...
			"zhCN": "狂暴的最大持续时间延长 5 秒, 其伤害加成提高 +{35/70/105/140/175/210/245/280/315/350}%。\n\nTags: 狂暴, 伤害.",
