...
Tags: Basic, Bleed, Slashing, Fury, Damage, Physical.`,
	...
	"Enhanced Flay": {
		...
		descriptionLocalized: {
			...
			"ptBR": "Esfolar tem 15% de chance de tornar os inimigos vulneráveis por 2 segundos. A chance é dobrada ao usar uma arma de duas mãos.",
	...
	"Battle Flay": {
		...
		descriptionLocalized: {
			...
			"ptBR": "Quando Esfolar causa dano direto a um inimigo, ele recebe x10% de dano de sangramento aumentado de você pelos próximos 3 segundos.",
...
Tags: Core, Bludgeoning, Fury, Physical, Damage, Two-Handed.`,
	...
	"Enhanced Hammer of the Ancients": {
		...
		descriptionLocalized: {
			...
			"ptBR": "Recebe x3% de fúria adicional por 5 segundos por cada inimigo atingido por Martelo dos Ancestrais, acumulando até 10 vezes.",
	...
	"Violent Hammer of the Ancients": {
		...
		descriptionLocalized: {
			...
			"ptBR": "Depois de desferir um Golpe Brutal com Martelo dos Ancestrais, você causa x30% de dano aumentado por 5 segundos.",
...
Tags: Core, Dual Wield, Damage, Physical, Fury.`,
	...
	"Violent Double Swing": {
		...
		descriptionLocalized: {
			...
			"ptBR": "Acertar um inimigo com ambos os golpes de Golpe Duplo torna-o vulnerável por 2 segundos.",
...
Tags: Core, Channeled, Fury, Physical, Damage.`,
	...
	"Violent Whirlwind": {
		...
		descriptionLocalized: {
			...
			"ptBR": "Depois de usar Redemoinho por 2 segundos, Redemoinho causa x30% de dano aumentado até ser cancelado.",
...
Tags: Defensive, Shout, Fury, Movement, Cooldown.`,
		...
		descriptionLocalized: {
			...
			"ptBR": "Recarga: 25 segundos\nSolta um brado de convocação, aumentando sua velocidade de movimento em +30% e a geração de recursos em x{40/44/48/52/56/60/64/68/72/76}% por 6 segundos, enquanto os aliados próximos recebem aumento por 3 segundos.\n\nTags: Defesa, Grito, Fúria, Movimento, Recarga.",
...
Tags: Brawling, Unstoppable, Crowd Control, Damage, Physical, Cooldown.`,
	...
	"Enhanced Charge": {
		...
		descriptionLocalized: {
			...
			"zhTW": "被衝鋒擊退撞到地形的敵人會受到 60% 點傷害並昏迷 3 秒。"
},
		id: 59,
		maxPoints: 1,
		x: -1012.34,
	...
	"Power Charge": {
		...
		description: `Reduce Charge's Cooldown by 3 seconds for each enemy it Knocks Back into terrain, up to 9 seconds.`,
		nameLocalized: {
		...
		descriptionLocalized: {
			"deDE": "Reduziert die Abklingzeit von Ansturm um 3 Sek. pro Gegner, der in Terrain gestoßen wird, bis maximal 9 Sek.",
			"esES": "Reduce 3 s el tiempo de reutilización de Carga por cada enemigo repelido contra el terreno, hasta un máximo de 9 s.",
			"esMX": "Reduce la recuperación de Carga 3 segundos por cada enemigo que golpea contra el terreno, hasta un máximo de 9 segundos.",
			"frFR": "Réduit le temps de recharge de Charge de 3 s pour chaque cible repoussée par Charge qui percute un obstacle, jusqu'à 9 s au maximum.",
			"itIT": "Riduce il tempo di recupero di Carica di 3 s per ogni nemico che respinge a terra, fino a un massimo di 9 s.",
			"jaJP": "〈チャージ〉によるノックバックで地形に叩きつけた敵1体ごとに、クールダウンが3秒短縮される。短縮量は最大で9秒。",
			"koKR": "돌진을 사용해 지형지물로 밀어내는 적 하나당 돌진의 재사용 대기시간이 3초만큼, 최대 9초까지 감소합니다.",
			"plPL": "Czas odnowienia Szarży jest skrócony o 3 sek. za każdym razem, gdy pchnie wroga na element otoczenia, maksymalnie do 9 sek.",
			"ptBR": "Reduz a recarga de Investida em 3 segundos por cada inimigo repelido em direção ao terreno, até 9 segundos.",
			"ruRU": "За каждого противника, отброшенного \"Натиском\" в препятствие, время восстановления этого умения сокращается на 3 сек. вплоть до 9 сек.",
			"trTR": "Geri Savurarak yere çarptığı her düşman için Hücum Bekleme Süresini 3 saniye azalt. Artış en fazla 9 olabilir.",
			"zhCN": "每有一个敌人被击退至地形上,冲锋的冷却时间就会缩短 3 秒,最多缩短 9 秒。",
			"zhTW": "衝鋒每將一名敵人擊退並撞至地形上,其冷卻時間縮短 3 秒,最多縮短 9 秒。"
},
		id: 60,
		maxPoints: 1,
		x: -1272.485,
...
Tags: Brawling, Shout, Damage, Cooldown.`,
		...
		descriptionLocalized: {
			...
			"ptBR": "Recarga: 25 segundos\nSolta um poderoso grito de guerra, aumentando seu dano causado em x{15/16.5/18/19.5/21/22.5/24/25.5/27/28.5}% por 6 segundos e o de aliados próximos por 3 segundos.\n\nTags: Briga, Grito, Dano, Recarga.",
...
Tags: Brawling, Crowd Control, Damage, Physical, Cooldown.`,
	...
	"Mighty Leap": {
		...
		descriptionLocalized: {
			...
			"ptBR": "Inimigos atingidos por Salto são desacelerados em 70% por 5 segundos.",
...
Tags: Brawling, Crowd Control, Damage, Physical, Cooldown.`,
		...
		descriptionLocalized: {
			...
			"ptBR": "Cargas: 2\nRecarga de cargas: {13/12.35/11.7/11.18/10.66/10.27/9.88/9.62/9.36/9.1/8.84/8.58/8.45/8.32/8.19/8.06/7.995/7.93/7.865/7.8} segundos\nChance de Golpe de Sorte: 40% (per hit)\nDesfere um chute poderoso que causa 18% de dano e repele inimigos à sua frente. Inimigos repelidos ao chão recebem 70% de dano adicional e ficam atordoados por 3 segundos.\n\nTags: Briga, Controle de Grupo, Dano, Física, Recarga.",
...
Tags: Weapon Mastery, Crowd Control, Damage, Physical, Cooldown.`,
	...
	"Enhanced Steel Grasp": {
		...
		descriptionLocalized: {
			...
			"ptBR": "Garra de Aço também deixa os inimigos vulneráveis por 3 segundos.",
...
Tags: Weapon Mastery, Bleed, Damage, Physical, Cooldown, Slashing.`,
	...
	"Enhanced Rupture": {
		...
		descriptionLocalized: {
			...
			"ptBR": "Arrancar sua arma de inimigos durante Ruptura provoca uma explosão que causa 70% de dano de sangramento ao longo de 5 segundos. Esse dano aumenta em x10% para cada 50 de força que você tiver.",
	...
	"Warrior's Rupture": {
		...
		descriptionLocalized: {
			...
			"ptBR": "Atingir inimigos com Ruptura aumenta sua velocidade de ataque em +40% por 5 segundos.",
...
Tags: Overpower, Damage, Two-Handed.`,
		...
		descriptionLocalized: {
			...
			"ptBR": "Seu Golpe Brutal causa x{15/30/45/60/75/90/105/120/135/150}% de dano aumentado ao usar uma arma de duas mãos.\n\nTags: Golpe Brutal, Dano, Duas mãos.",
...
Tags: Berserking, Damage.`,
	...
	"Gushing Wounds": {
		connections: [ "Key Passive" ],
		description: `When causing an enemy to Bleed, you have a chance equal to your Critical Strike Chance to increase the Bleed amount by x115% of your Critical Strike Damage bonus.
...
Tags: Bleed, Critical Strikes, Overpower, Damage.`,
		...
		descriptionLocalized: {
			"deDE": "Wenn Ihr bei einem Gegner Blutung verursacht, besteht eine Chance in Höhe Eurer kritischen Trefferchance, die Blutungsmenge um x115% Eures Bonus auf kritischen Trefferschaden zu erhöhen.\n\nDas Überwältigen eines blutenden Gegners löst eine Explosion aus, die im Verlauf von 5 Sek. 70% Blutungsschaden verursacht.\n\nTags: Blutung, Kritische Treffer, Überwältigen, Schaden.",
			"esES": "Cuando le provocas sangrado a un enemigo, tienes una probabilidad equivalente a tu probabilidad de golpe crítico de aumentar la cantidad de sangrado una cantidad equivalente a un x115% de tu bonus de daño de golpe crítico.\n\nArrollar a un enemigo con sangrado crea una explosión que inflige 70% de daño de sangrado durante 5 s.\n\nTags: Sangrado, Golpes críticos, Arrollamiento, Daño.",
			"esMX": "Al causar sangrado, tienes una probabilidad igual a tu probabilidad de golpe crítico de aumentar el valor de sangrado un x115% de tu bonificación de daño de golpe crítico.\n\nAbrumar a un enemigo que sangra crea una explosión que inflige 70% de daño de sangrado durante 5 segundos.\n\nTags: Sangrado, Golpes críticos, Abrumar, Daño.",
			"frFR": "Lorsque vous faites saigner une cible, vous avez des chances égales à vos chances d'infliger un coup critique d'augmenter le montant du saignement de x115% de votre bonus aux dégâts critiques.\n\nAccabler une cible qui saigne déclenche une explosion qui inflige 70% points de dégâts de saignement en 5 s.\n\nTags: Saignement, Coups critiques, Accablement, Dégâts.",
			"itIT": "Infliggendo sanguinamento a un nemico, hai una probabilità pari alla tua probabilità di critico di aumentare i danni da sanguinamento del x115% del bonus ai tuoi danni critici.\n\nInfliggere Sopraffazione a un nemico sanguinante crea un'esplosione che infligge 70% danni da sanguinamento in 5 s.\n\nTags: Sanguinamento, Colpi critici, Sopraffazione, Danni.",
			"jaJP": "敵を流血させると、クリティカルヒット率と同じ確率で流血量がクリティカルヒットダメージボーナスのx115%増加する。\n\n流血状態の敵に対してオーバーパワーを発生させると、5秒間かけて70%の流血ダメージを与える爆発を起こす。\n\nTags: 流血, クリティカルヒット, オーバーパワー, ダメージ.",
			"koKR": "적을 출혈시킬 때, 극대화 확률과 동일한 확률로 출혈량이 추가 극대화 피해의 x115%만큼 증가합니다.\n\n출혈 중인 적을 제압하면 폭발이 일어나 5초에 걸쳐 70%의 출혈 피해를 줍니다.\n\nTags: 출혈, 극대화, 제압, 피해.",
			"plPL": "Kiedy wywołujesz u wroga krwawienie, masz szansę równą twojej szansie na trafienie krytyczne na zwiększenie krwawienia o równowartość x115% twojej premii do obrażeń od trafień krytycznych.\n\nPrzytłoczenie krwawiącego wroga wywołuje eksplozję, która zadaje 70% pkt. obrażeń od krwawienia w ciągu 5 sek.\n\nTags: Krwawienie, Trafienia Krytyczne, Przytłoczenie, Obrażenia.",
			"ptBR": "Ao fazer um inimigo sangrar, você tem chance equivalente à sua chance de acerto crítico de aumentar o valor de sangramento dele em x115% do seu bônus de dano de acerto crítico.\n\nDesferir um Golpe Brutal contra um inimigo que está sangrando cria uma explosão que aplica 70% de dano de sangramento ao longo de 5 segundos.\n\nTags: Sangramento, Acertos Críticos, Golpe Brutal, Dano.",
			"ruRU": "Когда вы вызываете у противника кровотечение, урон от кровотечения увеличивается на x115% бонуса к урону от критических ударов с вероятностью, равной шансу критического удара.\n\nКогда вы наносите подавляющий урон кровоточащему противнику, происходит взрыв, наносящий врагам 70% ед. урона от кровотечения в течение 5 сек.\n\nTags: Кровотечение, Критические удары, Подавление, Урон.",
			"trTR": "Bir düşmanın Kanamasına neden olduğunda Kritik Vuruş İhtimaline eşit ihtimalle Kanama miktarını Kritik Vuruş Hasarı bonusunun x115% kadarına eşit artır.\n\nKanayan bir düşmana Aşırı Güç uygulamak 5 saniye boyunca 70% Kanama hasarı uygulayan bir patlama yaratır.\n\nTags: Kanama, Kritik Vuruşlar, Aşırı Güç, Hasar.",
			"zhCN": "使敌人流血时,你有一定几率 (等同于你的暴击几率) 提高流血量,提高的具体数值为你的暴击伤害加成的 x115%。\n\n压制一名流血的敌人会产生爆炸,在 5 秒内造成 70% 点流血伤害。\n\nTags: 流血, 暴击, 压制, 伤害.",
			"zhTW": "對敵人造成流血時有機率使流血傷害提高,機率等同你的爆擊機率,傷害加成等同你爆擊傷害加成的 x115%。\n\n壓制流血的敵人會產生爆炸,在 5 秒內造成 70% 點流血傷害。\n\nTags: 流血, 爆擊, 壓制, 傷害."
},
		id: 121,
		maxPoints: 1,
		x: 666.365,
...
Tags: Damage, Two-Handed, Dual Wield, Bludgeoning, Slashing.`,
		...
		descriptionLocalized: {
			...
			"ptBR": "Causar dano direto com uma arma de concussão de duas mãos, arma de corte de duas mãos ou arma de empunhadura dupla concede x10% de dano aumentado por 8 segundos.\n\nEnquanto todos os três bônus de dano estiverem ativos, você receberá um adicional de x15% de dano aumentado.\n\nTags: Dano, Duas mãos, Empunhadura Dupla, Concussão, Corte.",
...
barbarianData["Weapon Expertise"] = {
	"One-Handed Axe Expertise": {
		...
		bonusLocalized: {
			...
			"ptBR": "Golpe de Sorte: Acertos críticos têm até 55% de chance de conceder x6% de velocidade de ataque aumentada por 2 segundos. O bônus de velocidade de ataque é dobrado ao usar dois machados.",
	...
	"Two-Handed Sword Expertise": {
		...
		bonusLocalized: {
			...
			"ptBR": "Você causa x30% de dano de sangramento aumentado por 5 segundos depois de matar um inimigo.",
