...
Upon getting hit, you have a 5% chance to apply Ice Armor.`,
		...
		descriptionLocalized: {
			...
			"jaJP": "クールダウン: 20秒\n氷の障壁を6秒間にわたり周囲に生み出し、基本ライフの{30/33/36/39/42/45/48/51/54/57}%にあたるのダメージを吸収する。〈アイス・アーマー〉を発動中は、与えた冷気ダメージの5%が障壁に追加される。\n\nTags: 防御, 凍結, 障壁, クールダウン, ダメージ.\n\n— Enchantment Effect —\n被弾した際に、5%の確率で〈アイス・アーマー〉が発動する。",
			...
			"zhTW": "冷卻時間:20 秒\n在你身邊形成寒冰屏障,持續 6 秒,吸收相當於 {30/33/36/39/42/45/48/51/54/57}% 基礎生命值的傷害。寒冰護甲啟用時,你所造成傷害的 5% 會累積至其屏障上。\n\nTags: 防禦, 冰霜, 屏障, 冷卻時間, 傷害.\n\n— Enchantment Effect —\n當你被擊中時,有 5% 機率獲得寒冰護甲。"
},
		id: 51,
		maxPoints: 5,
		x: 421.865,
